...
import { CreateFileNodeWithTransactions, RestoreWatcherWithTransactions } from './restore.js'
...
describe('Restore Tests', () => {
  ...
  it('RestoreWatcherWithTransactions', async () => {
    ...
    const { watcher } = await NewVirtualPathWatcher(rootUUID, root, new ExtraPayload(v4(), true))
