...
export declare class VirtualTree {
  ...
  Handler(
    event: Event,
    extra?: ExtraPayload
  ): Promise<{ eventTransaction: EventTransaction }>
...
export declare function NewVirtualPathWatcher(
  uUID?: string,
  virtualPath?: VirtualPath,
  extra?: ExtraPayload
): Promise<{ watcher: VirtualTree; eventTransaction: EventTransaction }>
